            ...
            {activeTab === 'details' ? (
                <form onSubmit={handleSubmit} className={styles.form}>
                    ...
                    <div className={styles.formContent}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px', backgroundColor: '#f8fafc', borderRadius: '8px', border: '1px solid #e2e8f0', marginBottom: '16px' }}>
                            <div>
                                <label className={styles.formLabel} style={{ marginBottom: '4px', display: 'block' }}>Auto Update Mode</label>
                                <p className={styles.helpText} style={{ margin: 0 }}>Automatically sync exchange rate from external API</p>
                            </div>
                            <label style={{ position: 'relative', display: 'inline-block', width: '44px', height: '24px' }}>
                                ...
                                <span style={{
                                    ...
                                    backgroundColor: formData.isAutoUpdate ? '#10b981' : '#cbd5e1',
                                    transition: '.3s', borderRadius: '34px'
                                }}>
                                    <span style={{
                                        position: 'absolute', height: '18px', width: '18px', left: '3px', bottom: '3px',
                                        backgroundColor: 'white', transition: '.3s', borderRadius: '50%',
                                        transform: formData.isAutoUpdate ? 'translateX(20px)' : 'none'
                                    }}></span>
                                </span>
                            </label>
                        </div>
