                                ...
                                <tr key={currency.id}>
                                    <td className={styles.currencyCell}>
                                        <div className={styles.flagContainer}>
                                            <Image
                                                src={`https://flagcdn.com/w80/${currency.code.toLowerCase().slice(0, 2)}.png`}
                                                alt={currency.code}
                                                fill
                                                sizes="32px"
                                                ...
                                                onError={(e) => {
                                                    ...
                                                    if (parent) {
                                                        const fallback = parent.querySelector(`.${styles.flagFallback}`);
                                                        if (!fallback) {
                                                            const fb = document.createElement('span');
                                                            fb.className = styles.flagFallback;
                                                            fb.textContent = currency.code.slice(0, 2).toUpperCase();
